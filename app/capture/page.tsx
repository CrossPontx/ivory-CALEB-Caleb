...
export default function CapturePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-ivory via-sand to-blush flex flex-col">
      {/* Header */}
      <header className="bg-white/80 backdrop-blur-sm border-b border-border sticky top-0 z-10 safe-top flex-shrink-0">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-6 sm:py-8 pb-safe">
          ...
          {/* Actions */}
          <div className="space-y-2.5 sm:space-y-3 pb-6">
            {capturedImage ? (
              <>
